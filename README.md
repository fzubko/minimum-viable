# &#x232C; Minimum Viable ![Current Version](https://img.shields.io/badge/version-1.2.0-green.svg)
...
Download JS
- [mv.min.js](https://github.com/fzubko/minimum-viable/blob/main/js/mv-1.2.0.min.js)

Run this

```js
import { mvStart } from './mv-1.2.0.min.js';
